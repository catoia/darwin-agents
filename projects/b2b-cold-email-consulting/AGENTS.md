...
**ID:** b2b-cold-email-consulting  
**Generation:** 1  
**Parent:** none  
**Pitch:** Cold email consulting service for B2B SaaS founders — teardown + strategy sessions at $200 each  
**Fitness target:** $800 revenue in 4 weeks (4 paid consulting sessions)  
...
- Your inbox: `projects/b2b-cold-email-consulting/inbox.md`
...
9. Commit             → git add -A && git commit -m "[b2b-cold-email-consulting] <description>" && git push
```

**Never end a session without committing.** Always prefix commit messages with `[b2b-cold-email-consulting]` so the God Agent can track which project made which changes. If you did nothing meaningful, write a note
...
pi --no-session \
   ...
   --context-files projects/b2b-cold-email-consulting/AGENTS.md \
   --append-system-prompt "You are a task agent for project b2b-cold-email-consulting. Your only job: <task>. When done, append results to projects/b2b-cold-email-consulting/task-log.md and exit." \
...
- Task agents work only within `projects/b2b-cold-email-consulting/`
- They report results by appending to `projects/b2b-cold-email-consulting/task-log.md`
...
- All files in `projects/b2b-cold-email-consulting/`
- `projects/b2b-cold-email-consulting/strategy.md` — your strategy (keep it live and current)
- `projects/b2b-cold-email-consulting/inbox.md` — instructions from God Agent (read and mark done)
- `projects/b2b-cold-email-consulting/metrics.json` — fitness data (God Agent reads this weekly)
- `projects/b2b-cold-email-consulting/revenue-manual.json` — revenue recorded by human (append-only)
- `projects/b2b-cold-email-consulting/experiments.md` — experiment log
- `projects/b2b-cold-email-consulting/task-log.md` — task agent report log
- `projects/b2b-cold-email-consulting/tasks/` — task brief files you write before spawning task agents
...
You own collecting your own metrics. Run `bash scripts/fetch-metrics.sh b2b-cold-email-consulting` before
...
# projects/b2b-cold-email-consulting/revenue-manual.json
...
bash scripts/fetch-metrics.sh b2b-cold-email-consulting
```
...
```bash
echo '{"date":"2026-05-01","revenue_usd":12.40}' > projects/b2b-cold-email-consulting/revenue-manual.json
```
...
`projects/b2b-cold-email-consulting/metrics.json` — always overwrite with latest, never append:
...
`projects/b2b-cold-email-consulting/experiments.md` — append-only:
...
`projects/b2b-cold-email-consulting/task-log.md` — task agents append here:
