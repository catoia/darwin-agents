...
**ID:** budget-recipe-blog  
**Generation:** 1  
**Parent:** none  
**Pitch:** SEO-optimized budget recipe blog monetized with AdSense and Amazon affiliate links  
**Fitness target:** $200 revenue in 6 weeks from AdSense + affiliate earnings  
...
- Your inbox: `projects/budget-recipe-blog/inbox.md`
...
9. Commit             → git add -A && git commit -m "[budget-recipe-blog] <description>" && git push
```

**Never end a session without committing.** Always prefix commit messages with `[budget-recipe-blog]` so the God Agent can track which project made which changes. If you did nothing meaningful, write a note
...
pi --no-session \
   ...
   --context-files projects/budget-recipe-blog/AGENTS.md \
   --append-system-prompt "You are a task agent for project budget-recipe-blog. Your only job: <task>. When done, append results to projects/budget-recipe-blog/task-log.md and exit." \
...
- Task agents work only within `projects/budget-recipe-blog/`
- They report results by appending to `projects/budget-recipe-blog/task-log.md`
...
- All files in `projects/budget-recipe-blog/`
- `projects/budget-recipe-blog/strategy.md` — your strategy (keep it live and current)
- `projects/budget-recipe-blog/inbox.md` — instructions from God Agent (read and mark done)
- `projects/budget-recipe-blog/metrics.json` — fitness data (God Agent reads this weekly)
- `projects/budget-recipe-blog/revenue-manual.json` — revenue recorded by human (append-only)
- `projects/budget-recipe-blog/experiments.md` — experiment log
- `projects/budget-recipe-blog/task-log.md` — task agent report log
- `projects/budget-recipe-blog/tasks/` — task brief files you write before spawning task agents
...
You own collecting your own metrics. Run `bash scripts/fetch-metrics.sh budget-recipe-blog` before
...
# projects/budget-recipe-blog/revenue-manual.json
...
bash scripts/fetch-metrics.sh budget-recipe-blog
```
...
```bash
echo '{"date":"2026-05-01","revenue_usd":12.40}' > projects/budget-recipe-blog/revenue-manual.json
```
...
`projects/budget-recipe-blog/metrics.json` — always overwrite with latest, never append:
...
`projects/budget-recipe-blog/experiments.md` — append-only:
...
`projects/budget-recipe-blog/task-log.md` — task agents append here:
